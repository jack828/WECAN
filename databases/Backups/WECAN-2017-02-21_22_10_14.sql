...
--
-- Host: localhost
-- Generation Time: Feb 21, 2017 at 10:39 PM
...
INSERT INTO `card` (`ID`, `competitorID`, `startDate`, `endDate`, `cardStateID`) VALUES
...
INSERT INTO `cardState` (`ID`, `state`) VALUES
(1, 'valid'),
(2, 'expired'),
(3, 'cancelled');
...
INSERT INTO `competitor` (`ID`, `titleID`, `fullName`, `role`, `teamID`, `authorised`) VALUES
...
INSERT INTO `competitorTitle` (`ID`, `title`) VALUES
(1, 'Mr'),
(2, 'Ms'),
(3, 'Dr');
...
INSERT INTO `matchAccess` (`ID`, `matchDate`, `venueID`, `team1ID`, `team2ID`) VALUES
(7, '2017-07-19', 1, 3, 4),
(8, '2017-07-19', 2, 1, 2),
(15, '2017-07-23', 3, 2, 4),
(16, '2017-07-23', 4, 1, 3),
...
INSERT INTO `team` (`ID`, `teamName`, `nfa`, `acronym`, `nickname`, `eliminated`) VALUES
...
INSERT INTO `venue` (`ID`, `venueName`, `stadium`) VALUES
...
INSERT INTO `venueUsage` (`ID`, `cardID`, `venueID`, `dateAccessed`, `accessGranted`) VALUES
(1, 11, 1, '2017-07-22', 0),
(2, 9, 3, '2017-07-28', 0),
(3, 4, 4, '2017-07-22', 1),
(4, 4, 1, '2017-07-21', 0),
