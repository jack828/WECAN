...
<div class="x_panel">
  ...
  <div class="x_content">
    <?php echo form_open($update_url, 'class="form-horizontal form-label-left" method="post" id="crudForm" autocomplete="off" enctype="multipart/form-data"'); ?>
      ...
      <div class="form-group">
        ...
        <?php if(!$this->unset_back_to_list) { ?>
          <input role='button' type='button' value='<?php echo $this->l('form_update_and_go_back'); ?>' class='btn btn-primary' id="save-and-go-back-button"/>
