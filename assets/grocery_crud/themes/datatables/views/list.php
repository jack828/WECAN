<table width="100%" cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-hover" id="<?php echo $unique_hash; ?>">
	...
	<tbody>
        ...
        <div class="actions-container">
  				...
  				?>
  				<?php if(!$unset_read){?>
  					<a href="<?php echo site_url('main/'.strtolower($subject).'/read/'.$row->ID); ?>" class="edit_button btn btn-xs btn-dark" role="button">
  				...
  				<?php if(!$unset_edit){?>
  					<a href="<?php echo site_url('main/'.strtolower($subject).'/edit/'.$row->ID); ?>" class="edit_button btn btn-xs btn-dark" role="button">
